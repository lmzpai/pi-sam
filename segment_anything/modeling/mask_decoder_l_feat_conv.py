...
class MaskDecoderLargeFeatConv(MaskDecoder):
    ...
    def forward(self, encoder_outputs, interm_embeddings=None, labels=None, labels_256=None, get_loss=False):
        ...
        pred_masks_s, up_embeddings, _ = self.pred_mask_1(srcs, tokens, hq_features, size, transformer_dim)

        new_src = self.embed_mask_1(up_embeddings, pred_masks_s)
        rgb_embeddings = rgb_features
        pred_masks_l = self.pred_mask_2(new_src, rgb_embeddings)
